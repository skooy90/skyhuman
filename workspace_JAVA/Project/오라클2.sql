...
CREATE TABLE BOM (
    ...
    QUANTITY NUMBER(2) NOT NULL                       -- 필요 수량
);
...
-- 오이 비누 베이스 1kg = 가성소다 11g
INSERT INTO BOM (BOM_ID, PARENT_ID, CHILD_ID, QUANTITY) 
SELECT SEQ_BOM_ID.NEXTVAL, p1.PRODUCT_ID, p2.PRODUCT_ID, 11
FROM PRODUCT p1, PRODUCT p2 
WHERE p1.PRODUCT_NAME = '오이 비누 베이스' AND p2.PRODUCT_NAME = '가성소다';

-- 오이 비누 베이스 1kg = 팜 오일 20g
INSERT INTO BOM (BOM_ID, PARENT_ID, CHILD_ID, QUANTITY) 
SELECT SEQ_BOM_ID.NEXTVAL, p1.PRODUCT_ID, p2.PRODUCT_ID, 20
FROM PRODUCT p1, PRODUCT p2 
WHERE p1.PRODUCT_NAME = '오이 비누 베이스' AND p2.PRODUCT_NAME = '팜 오일';

-- 오이 비누 베이스 1kg = 올리브 오일 13g
INSERT INTO BOM (BOM_ID, PARENT_ID, CHILD_ID, QUANTITY) 
SELECT SEQ_BOM_ID.NEXTVAL, p1.PRODUCT_ID, p2.PRODUCT_ID, 13
FROM PRODUCT p1, PRODUCT p2 
